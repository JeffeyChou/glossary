...
 & \lim_{n\rightarrow\infty} \frac{1}{\sum\limits_{k=1}^n \sigma^2} \sum\limits_{k=1}^n \int_{\{ \lvert x-\mu_k \rvert > \epsilon \sum\limits_{k=1}^n \sigma^2 \}} (x-\mu_k)^2 \boldsymbol{d} F_{k}(x)\\
